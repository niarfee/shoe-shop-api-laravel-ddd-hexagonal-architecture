...
final class OrderAlreadyContainsOrderLineForProductVariantException extends BaseDomainException
{
    public function __construct(OrderId $orderId, ProductVariantId $productVariantId)
    {
        parent::__construct(
            sprintf(
                'Order <%s> already contains a OrderLine for ProductVariant <%s>.',
                $orderId->value(),
